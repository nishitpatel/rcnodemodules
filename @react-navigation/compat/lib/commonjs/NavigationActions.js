...
function back(options) {
  return (options === null || options === void 0 ? void 0 : options.key) != null ? state => _objectSpread({}, _native.CommonActions.goBack(), {
    source: options.key,
    target: state.key
...
function setParams({
  ...
  return _objectSpread({}, _native.CommonActions.setParams(params), {}, key !== undefined ? {
    source: key
  } : null);
}
